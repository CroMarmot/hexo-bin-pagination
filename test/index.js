...
describe('paginator', () => {
  ...
  before(async () => {
    ...
    paginator = mod.default.bind(ctx);
  });
  ...
  it('current = 512, total = 1023', () => {
    ...
    checkResult(result, {
      ...
      total: 1023,
      pages: [
        1, 257, 385, 449, 481, 497, 505, 509, 511, 512, 513, 515, 519, 527, 543,
        575, 639, 767, 1023,
      ],
    });
  });
  ...
  it('current = 513, total = 1024', () => {
    ...
    checkResult(result, {
      ...
      total: 1024,
      pages: [
        1, 2, 258, 386, 450, 482, 498, 506, 510, 512, 513, 514, 516, 520, 528,
